...
export default function DomeGallery({
  ...
  // openItemFromElement needs to be defined before useGesture that references it
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      (el.style as unknown as Record<string, string>).zIndex = "0";
  ...
  return (
    <>
      {/* biome-ignore lint/security/noDangerouslySetInnerHtml: required for sphere CSS custom properties */}
            ...
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  ...
                  >
                    {/* Raw img required: dome JS imperatively clones/repositions nodes; next/image wrapper breaks this */}
                    <img
                      src={it.src}
                      draggable={false}
                      alt={it.alt}
