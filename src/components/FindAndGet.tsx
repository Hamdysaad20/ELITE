...
export default function FindAndGet() {
  ...
  return (
    <section className="bg-brewhaus-cream py-20 xl:py-36 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div ref={coffeeRef} className="flex flex-col items-center group cursor-pointer">
            <div className="w-48 h-48 lg:w-64 lg:h-64 rounded-full bg-brewhaus-green overflow-hidden mb-8 transition-transform group-hover:scale-105 shadow-lg">
              <img
