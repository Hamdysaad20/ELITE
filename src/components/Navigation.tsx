      ...
      <nav className="sticky top-0 z-50 hidden md:block">
        ...
        <div>
          <div className="max-w-7xl mx-auto flex items-center justify-center py-3 px-6">
            ...
            <div
              className={cn(
                "bg-elite-cream rounded-full w-full max-w-[1400px] shadow-2xl px-8 py-4",
              )}
            >
              <div
                className={cn(
              ...
              >
                ...
                <LocalizedLink
                  href="/"
                  className="absolute left-1/2 -translate-x-1/2 rounded-lg flex items-center justify-center px-8 h-20 -my-3 hover:scale-105 transition-transform duration-300"
                >
                  <div className="relative h-16 w-24">
                    <ImageWithFallback
                      ...
                      objectFit="contain"
                      fallbackSrc="/images/PRINTING_CUP.png"
                      showErrorIcon={false}
                      priority
                    />
                  </div>
                ...
                >
                  ...
                  <div className="relative" ref={dropdownRef}>
                    {status === "loading" ? (
                      ...
                      >
                        <span
                          className={cn("text-base", !isRTL && "uppercase")}
                        >
                          {t("signIn")}
                        </span>
                      </LocalizedLink>
